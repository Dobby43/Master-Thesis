...
class RobotOPW:
    ...
    def inverse_kinematics(self, hom_trans):
        ...
        cx0 = hom_trans[0, 3] - tool_offset_robotroot[0] - c4_robotroot[0]
        cy0 = hom_trans[1, 3] - tool_offset_robotroot[1] - c4_robotroot[1]
        cz0 = hom_trans[2, 3] - tool_offset_robotroot[2] - c4_robotroot[2]
        ...
        # Changed to: cx0**2 + cy0**2 >= self.b**2 -> before np.isreal(sqrt(b**2 - (cx0**2 + cy0**2)))
